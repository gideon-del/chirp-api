package com.gideon.chirp.infra.push_notification

import com.gideon.chirp.domain.model.DeviceToken
import com.gideon.chirp.domain.model.PushNotification
import com.gideon.chirp.domain.model.PushNotificationSendResult
...
logger.error("Error initializing Firebase Admin SDK")
    ...
    fun isValidToken(token: String): Boolean {
        ...
        return  try {
            ...
            logger.warn("Failed to validate message token")
             false
        }
    }
    ...
    private  fun BatchResponse.toSendResult(
        ...
        logger.debug("Push notifications sent. Succeeded: ${succeeded.size}. " +
                "Temporary Failures: ${temporaryFailures.size}" + "Permanent failure: ${permanentFailures.size}")
